...
# app/routers/report_routers.py
from app.models import user_models  # if you have user models separated
from app.models import report       # if you have a separate report.py
