...
import HistoricalGraph from "../components/HistoricalGraph"; // ✅ ADD THIS
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto grid grid-cols-[220px_1fr] gap-6 p-6">
        ...
        <main className="bg-white p-6 rounded shadow">
          ...
          {showTable === "reports" && (
            <>
              {/* Existing Verified Reports Table */}
              ...
            </>
          )}

          {/* ✅ CONDITIONAL RENDER: Historical Graph */}
