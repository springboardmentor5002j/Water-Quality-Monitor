...
from .models import User, WaterStation, StationReading, ReadingParameterfrom .models.user import User
from .models.water_station import WaterStation
from .models.station_reading import StationReading
from .models.enums import ReadingParameter
