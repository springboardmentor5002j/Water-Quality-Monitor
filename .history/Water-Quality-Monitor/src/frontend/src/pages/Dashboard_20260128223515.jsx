...
export default function Dashboard() {
  ...
  /* ---------------- VERIFY / REJECT ---------------- */
  const handleVerifyReject = (reportId, action) => {
    ...
    // TODO: Connect this with backend API in Week-8
  };
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-7xl mx-auto grid grid-cols-[220px_1fr] gap-6 p-6">
        ...
        <main className="bg-white p-6 rounded shadow">
          ...
          {showTable === "reports" && (
            <VerifiedReportsTable reports={verifiedReports} onAction={handleVerifyReject} />
          )}
        </main>
      </div>
    </div>
...
const VerifiedReportsTable = ({ reports, onAction }) => (
  <>
