...
# -------------------------------------
# ADDITIONAL MODELS FOR NGO COLLABORATION
# -------------------------------------

# Collaboration Request (for NGO project collaboration requests)
class CollaborationRequest(Base):
    ...
    ngo = relationship("User")  # link to NGO user


# NGO Projects (for tracking NGO project status)
