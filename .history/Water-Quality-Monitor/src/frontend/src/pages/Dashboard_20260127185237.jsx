...
import HistoricalGraph from "../components/HistoricalGraph"; // import the graph component
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-[220px_1fr] gap-6 p-6">
        ...
        <main className="bg-white p-6 rounded shadow">
            ...
            <>
              ...
              {stations.map((s) => (
                <div key={s.id} className="border p-4 rounded mb-3 bg-gray-50">
                  ...
                  <p>
                    <strong>Managed By:</strong> {s.managed_by}
                  </p>
                  <p>
            ...
            <>
              ...
              {stations.map((s) => (
                <div key={s.id} className="border p-4 rounded mb-4 bg-gray-50">
                  ...
                  {Array.isArray(s.latest_readings) && s.latest_readings.length > 0 ? (
          ...
          {showTable === "history" && stations.length > 0 && (
            <>
              <h3 className="text-lg font-semibold mb-3">📈 Historical Water Quality Trends</h3>
